package cn.dreampie.pool.thread;
...
public class ThreadPoolKit {
  ...
  public static ExecutorService fixedPool(int num) {
  ...
  public static ExecutorService scheduledPool(int num) {
